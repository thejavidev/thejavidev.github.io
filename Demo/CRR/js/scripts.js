...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 80) {
            ...
            logo.attr('src', 'img/logo-white.webp');
        }
    });
    ...
    var swiperBlogImg = new Swiper('.swiper-img', {
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 800,
        loop: true,
    ...
    var swiperBlogContent = new Swiper('.swiper-content', {
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 800,
        loop: true,
        ...
        navigation: {
            nextEl: '.controls .next-ctrl',
            prevEl: '.controls .prev-ctrl'
        },
    });

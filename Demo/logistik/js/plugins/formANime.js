...
tl.fromTo(hero, 3, { width: "0%" }, { width: "100%" ,else:Power2.easeInOut},"-=1");

tl.fromTo(ship, 1.5,{x: -120, opacity:0},{x:0, opacity:1 },"-=1");
...
tl.fromTo(loc2, 1.5,{x: -160,opacity:0},{x: 0,opacity:1 },"-=1");
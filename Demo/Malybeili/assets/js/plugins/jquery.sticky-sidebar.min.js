											...
											if (!this._breakpoint) {
												...
												if ((this.affixedType != e || t) && e) {
													...
													for (var r in i.inner) {
														var a =
															'number' == typeof i.inner[r]
																? 'px'
																: '';
														this.sidebarInner.style[r] =
															i.inner[r] + a;
													}
													var p =
														'affixed.' +
									...
									return this.each(function () {
										...
										if (
											...
											if (
												void 0 === e[i] &&
												-1 ===
													['destroy', 'updateSticky'].indexOf(i)
											)
												throw new Error(
													'No method named "' + i + '"'
												);
